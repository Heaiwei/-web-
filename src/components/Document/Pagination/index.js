...
class Pagination extends Component {
	...
	componentWillReceiveProps(nextProps){
		if (this.props.pageConfig !== nextProps.pageConfig){
				this.setState({
					totalPage: nextProps.pageConfig,
				});
		}
		if(this.props.pageChange!==nextProps.pageChange){
			this.setState({
				currentPage:nextProps.pageChange
			});
		}
	}
	...
	componentDidMount() {
		this.setState({
			totalPage: this.props.documentStore.CurrentAllDocumItem
		});
		this.props.pageCallbackFn(this.state.currentPage);
		console.log(this.props.documentStore.CurrentAllDocumItem);
	}
